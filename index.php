        ...
        <form action="home_login.asp?e=1" method="post" autocomplete="off">
            <div id="myForm">
                <div class="row">
                    ...
                    <div class="col-input my-input"><input type="number" name="fUser" placeholder="เลข 13หลัก" class="center" required=""
                            value="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 control-label">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01"> <b> คำนำหน้านาม</b><font color="#FF0000">*</font>
                        </label>
                    </div>
